...
| `tools/cdf_strings_report.py` | Summarise metadata strings extracted from a CDF ASCII dump. | `python tools/cdf_strings_report.py <file.cdf> [--variables V1 V2 …] [--window N]`.【F:tools/cdf_strings_report.py†L160-L214】 |
