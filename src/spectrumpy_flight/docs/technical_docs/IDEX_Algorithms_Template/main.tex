...
\rhead{\today}
\lhead{%
  \IfFileExists{images/imap_logo.png}{\includegraphics[width=3cm]{images/imap_logo.png}}{\fbox{imap\_logo.png}}%
  \hspace{1cm} \bfseries \Large IDEX Algorithms Template
}
\rfoot{%
  \IfFileExists{images/lasp_logo.png}{\includegraphics[width=5cm]{images/lasp_logo.png}}{\fbox{lasp\_logo.png}}%
}
...
\begin{titlepage}
  ...
  \vskip3.5cm}
  \vfill
  \IfFileExists{images/lasp_logo.png}{\includegraphics[width=10cm]{lasp_logo.png}}{\fbox{lasp\_logo.png}}
  \quad
  \IfFileExists{images/imap_logo.png}{\includegraphics[width=10cm]{imap_logo.png}}{\fbox{imap\_logo.png}}
  \vfill
\end{titlepage}
