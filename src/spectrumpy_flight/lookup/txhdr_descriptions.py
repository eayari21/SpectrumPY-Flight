...
UNPACKED_FIELD_DESCRIPTIONS = {
    ...
    "TOFDelay_M": "Decoded TOF-M (ADC1Q) sample delay from IDX__TXHDRSAMPDELAY.",
    "TOFDelay_L": "Decoded TOF-L (ADC0Q) sample delay from IDX__TXHDRSAMPDELAY.",
    "TriggerOrigin": "Decoded trigger-origin labels from IDX__TXHDRTRIGID bitfield.",
